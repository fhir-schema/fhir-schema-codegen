...
export const attach_Vitalspanel = (resource: Observation, profile: Vitalspanel): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): Vitalspanel => {
    ...
    if (resource.hasMember === undefined) {
        throw new Error("'hasMember' is required for http://hl7.org/fhir/StructureDefinition/vitalspanel");
    }
    ...
    return {
        ...
        subject: resource.subject as Vitalspanel['subject'],
