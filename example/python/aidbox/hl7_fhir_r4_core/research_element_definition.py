...
class ResearchElementDefinitionCharacteristic(BackboneElement):
    ...
    definition_canonical: str = Field(alias="definitionCanonical", serialization_alias="definitionCanonical")
    definition_codeable_concept: CodeableConcept = Field(alias="definitionCodeableConcept", serialization_alias="definitionCodeableConcept")
    definition_data_requirement: DataRequirement = Field(alias="definitionDataRequirement", serialization_alias="definitionDataRequirement")
    definition_expression: Expression = Field(alias="definitionExpression", serialization_alias="definitionExpression")
...
class ResearchElementDefinition(DomainResource):
    ...
    characteristic: PyList[ResearchElementDefinitionCharacteristic] = Field(alias="characteristic", serialization_alias="characteristic")
    ...
    type: Literal["population", "exposure", "outcome"] = Field(alias="type", serialization_alias="type")
