...
export const attach_Oxygensat = (resource: Observation, profile: Oxygensat): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): Oxygensat => {
    ...
    return {
        ...
        subject: resource.subject as Oxygensat['subject'],
