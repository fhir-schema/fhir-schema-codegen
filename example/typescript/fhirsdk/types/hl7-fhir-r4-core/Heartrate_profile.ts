...
export interface Heartrate {
    __profileUrl: 'http://hl7.org/fhir/StructureDefinition/heartrate';
...
export const attach_Heartrate = (resource: Observation, profile: Heartrate): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): Heartrate => {
    if (resource.category === undefined) {
        throw new Error("'category' is required for http://hl7.org/fhir/StructureDefinition/heartrate");
    }
    
    if (resource.subject === undefined) {
        throw new Error("'subject' is required for http://hl7.org/fhir/StructureDefinition/heartrate");
    }
    ...
    return {
        ...
        subject: resource.subject as Heartrate['subject'],
