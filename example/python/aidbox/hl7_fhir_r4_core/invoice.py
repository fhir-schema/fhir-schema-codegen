...
class InvoiceLineItem(BackboneElement):
    ...
    charge_item_codeable_concept: CodeableConcept = Field(alias="chargeItemCodeableConcept", serialization_alias="chargeItemCodeableConcept")
    charge_item_reference: Reference = Field(alias="chargeItemReference", serialization_alias="chargeItemReference")
