...
export const attach_Resprate = (resource: Observation, profile: Resprate): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): Resprate => {
    ...
    return {
        ...
        subject: resource.subject as Resprate['subject'],
