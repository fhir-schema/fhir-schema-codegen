    ...
    resource = {
        ...
        conditionalUpdate: <T extends keyof ResourceTypeMap>(
            ...
            return new FindBeforeAction((searchParams: URLSearchParams) => {
                return this.client.patch(buildResourceUrl(resourceName), {
                    json: input,
                    searchParams,
                });
            }, resourceName);
        ...
        conditionalCreate: <T extends keyof ResourceTypeMap>(
            ...
            return new FindBeforeAction((searchParams: URLSearchParams) => {
                return this.client.post(buildResourceUrl(resourceName), {
                    json: input,
                    searchParams,
                });
            }, resourceName);
        ...
        conditionalOverride: <T extends keyof ResourceTypeMap>(
            ...
            return new FindBeforeAction((searchParams: URLSearchParams) => {
                return this.client.put(buildResourceUrl(resourceName), {
                    json: input,
                    searchParams,
                });
            }, resourceName);
