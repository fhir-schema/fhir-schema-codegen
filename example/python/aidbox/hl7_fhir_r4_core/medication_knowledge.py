...
class MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics(BackboneElement):
    ...
    characteristic_codeable_concept: CodeableConcept = Field(alias="characteristicCodeableConcept", serialization_alias="characteristicCodeableConcept")
    characteristic_quantity: Quantity = Field(alias="characteristicQuantity", serialization_alias="characteristicQuantity")
