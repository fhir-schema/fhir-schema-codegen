...
from aidbox.hl7_fhir_r4_core.base import Attachment, CodeableConcept, ContactDetail, DataRequirement, Identifier, ParameterDefinition, Period, Reference, RelatedArtifact, UsageContext
...
class Library(DomainResource):
    ...
    content: Optional[L[Attachment]] = Field(None, alias="content", serialization_alias="content")
    ...
    parameter: Optional[L[ParameterDefinition]] = Field(None, alias="parameter", serialization_alias="parameter")
