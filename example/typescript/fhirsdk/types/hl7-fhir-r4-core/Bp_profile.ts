...
export interface Bp {
    __profileUrl: 'http://hl7.org/fhir/StructureDefinition/bp';
...
export const attach_Bp = (resource: Observation, profile: Bp): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): Bp => {
    if (resource.category === undefined) {
        throw new Error("'category' is required for http://hl7.org/fhir/StructureDefinition/bp");
    }
    
    if (resource.subject === undefined) {
        throw new Error("'subject' is required for http://hl7.org/fhir/StructureDefinition/bp");
    }
    ...
    return {
        ...
        subject: resource.subject as Bp['subject'],
