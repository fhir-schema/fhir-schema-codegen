...
class MedicationRequestSubstitution(BackboneElement):
    ...
    allowed_boolean: bool = Field(alias="allowedBoolean", serialization_alias="allowedBoolean")
    allowed_codeable_concept: CodeableConcept = Field(alias="allowedCodeableConcept", serialization_alias="allowedCodeableConcept")
...
class MedicationRequest(DomainResource):
    ...
    intent: Literal["proposal", "plan", "order", "original-order", "reflex-order", "filler-order", "instance-order", "option"] = Field(alias="intent", serialization_alias="intent")
    ...
    status: Literal["active", "on-hold", "cancelled", "completed", "entered-in-error", "stopped", "draft", "unknown"] = Field(alias="status", serialization_alias="status")
