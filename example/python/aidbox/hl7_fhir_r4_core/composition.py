...
class CompositionRelatesTo(BackboneElement):
    ...
    target_identifier: Identifier = Field(alias="targetIdentifier", serialization_alias="targetIdentifier")
    target_reference: Reference = Field(alias="targetReference", serialization_alias="targetReference")
