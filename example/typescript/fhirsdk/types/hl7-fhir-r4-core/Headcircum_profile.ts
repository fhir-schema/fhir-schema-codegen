...
export const attach_Headcircum = (resource: Observation, profile: Headcircum): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): Headcircum => {
    ...
    return {
        ...
        subject: resource.subject as Headcircum['subject'],
