...
class ExplanationOfBenefitDiagnosis(BackboneElement):
    ...
    diagnosis_codeable_concept: CodeableConcept = Field(alias="diagnosisCodeableConcept", serialization_alias="diagnosisCodeableConcept")
    diagnosis_reference: Reference = Field(alias="diagnosisReference", serialization_alias="diagnosisReference")
...
class ExplanationOfBenefitProcedure(BackboneElement):
    ...
    date: str | None = Field(None, alias="date", serialization_alias="date")
    procedure_codeable_concept: CodeableConcept = Field(alias="procedureCodeableConcept", serialization_alias="procedureCodeableConcept")
    procedure_reference: Reference = Field(alias="procedureReference", serialization_alias="procedureReference")
    sequence: PositiveInt = Field(alias="sequence", serialization_alias="sequence")
    type: PyList[CodeableConcept] | None = Field(None, alias="type", serialization_alias="type")
    udi: PyList[Reference] | None = Field(None, alias="udi", serialization_alias="udi")
...
class ExplanationOfBenefit(DomainResource):
    ...
    insurance: PyList[ExplanationOfBenefitInsurance] = Field(alias="insurance", serialization_alias="insurance")
