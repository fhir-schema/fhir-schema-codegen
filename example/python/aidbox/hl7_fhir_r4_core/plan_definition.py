...
class PlanDefinitionAction(BackboneElement):
    ...
    input: PyList[DataRequirement] | None = Field(None, alias="input", serialization_alias="input")
    output: PyList[DataRequirement] | None = Field(None, alias="output", serialization_alias="output")
