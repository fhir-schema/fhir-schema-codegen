...
export const extract_Observation = (resource: Observation): Bmi => {
    ...
    if (resource.valueQuantity === undefined) {
        throw new Error("'valueQuantity' is required for http://hl7.org/fhir/StructureDefinition/bmi");
    }
    ...
    return {
        ...
        subject: resource.subject as Bmi['subject'],
