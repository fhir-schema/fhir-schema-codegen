...
class QuestionnaireItemEnableWhen(BackboneElement):
    ...
    answer_boolean: bool = Field(alias="answerBoolean", serialization_alias="answerBoolean")
    answer_coding: Coding = Field(alias="answerCoding", serialization_alias="answerCoding")
    answer_date: str = Field(alias="answerDate", serialization_alias="answerDate")
    answer_date_time: str = Field(alias="answerDateTime", serialization_alias="answerDateTime")
    answer_decimal: float = Field(alias="answerDecimal", serialization_alias="answerDecimal")
    answer_integer: int = Field(alias="answerInteger", serialization_alias="answerInteger")
    answer_quantity: Quantity = Field(alias="answerQuantity", serialization_alias="answerQuantity")
    answer_reference: Reference = Field(alias="answerReference", serialization_alias="answerReference")
    answer_string: str = Field(alias="answerString", serialization_alias="answerString")
    answer_time: str = Field(alias="answerTime", serialization_alias="answerTime")
