...
export const attach_Vitalsigns = (resource: Observation, profile: Vitalsigns): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_Observation = (resource: Observation): Vitalsigns => {
    ...
    return {
        ...
        subject: resource.subject as Vitalsigns['subject'],
