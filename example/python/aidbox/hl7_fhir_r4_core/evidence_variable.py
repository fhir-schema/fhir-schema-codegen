...
class EvidenceVariableCharacteristic(BackboneElement):
    ...
    definition_reference: Reference = Field(alias="definitionReference", serialization_alias="definitionReference")
    definition_trigger_definition: TriggerDefinition = Field(alias="definitionTriggerDefinition", serialization_alias="definitionTriggerDefinition")
